...
function initializer() {
    ...
    var percentage1: number = 0.85;
    var percentage2: number = 0.07;
    var percentage3: number = 0.07;
    var percentage4: number = 0.01;

    var canvasSurface = <HTMLCanvasElement> document.getElementById("myCanvas");
